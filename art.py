...
parser.add_argument('--style_reference_image_path', default='examples/starry.jpg', type=str, required=False,
...
# 自定义参数的设置
args = parser.parse_args(['--base_image_path', 'examples/gasson.jpg'])
...
#     loss = loss + total_variation_weight * total_variation_loss(combination_image)
# grads = gtape.gradient(loss,combination_image)[0]
